...
import ktIphoneData from '@/data/private/kt-pricing-parsed.json';
import ktAndroidData from '@/data/private/kt-android-parsed.json';
...
export function buildModelIndex() {
  ...
  // Add iPhones
  ktIphoneData.iphones?.forEach(device => {
