...
const ShippingSelection = ({ 
  ...
  const loadShippingRates = async () => {
    ...
    try {
      ...
      const packageParcel = parcel || shippingService.constructor.getPhoneParcel();
  ...
  return (
    <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-xl font-bold">Choose Shipping Method</h3>
      </div>
      ...
      {/* Shipping Info */}
      <div className="mt-6 p-4 bg-purple-900/10 rounded-lg border border-purple-900/30">
        <h4 className="text-sm font-semibold text-purple-400 mb-2">
          How ReFit Shipping Works:
        </h4>
        <ul className="space-y-1 text-sm text-gray-400">
          <li>• We'll email you a prepaid shipping label</li>
          <li>• Pack your phone securely (we recommend original box)</li>
          <li>• Drop off at any {rates[0]?.carrier || 'carrier'} location</li>
          <li>• Track your package until it reaches our facility</li>
